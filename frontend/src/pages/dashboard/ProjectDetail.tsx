...
export default function ProjectDetail() {
  ...
  const handleStartAnalysis = async () => {
    ...
    toast({ title: 'Coming soon', description: 'Data analysis will be available in the next update' })
  }
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full ${status.color}`}>
        <StatusIcon className={`w-4 h-4 ${project.status === 'analyzing' || project.status === 'training' ? 'animate-spin' : ''}`} />
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          {dataset ? (
            ...
            <div className="text-sm text-gray-500">
              ...
              <Link to={`/dashboard/new-project`} className="text-blue-500 hover:underline">
                Link a dataset
              </Link>
            </div>
          )}
      ...
      {project.status === 'dataset_linked' && (
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 p-6">
          <div className="flex items-center justify-between">
            ...
            <Button onClick={handleStartAnalysis} className="bg-blue-600 hover:bg-blue-700 gap-2">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="flex items-center justify-between">
          {[
            ...
            { step: 2, label: 'Analysis', status: project.analysis_results ? 'completed' : project.status === 'analyzing' ? 'active' : 'pending' },
